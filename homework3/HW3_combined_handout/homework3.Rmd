...
From the figure in question 1.1, we can see the the set of outliers that follow the sigmoidal-like curve. These outliers might correspond to the cDNA fragments that came from RNAs with very low expression level. Therefore, those cDNA might have very low read coverage which in extreme cases it can even be that those cDNA were represented by single limited size read. The upper bound of effective size in those cDNA might correspond to the largest possible read size of the type of sequencing machine that was used in this experiment.
