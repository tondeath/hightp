...
After downloading RefSeq track, the -300 to -1 regions around TSSs were selected using below command. The option -l was for specifying the size of region upstream, -r for region downstream and option -s to specify bedtools to select region based on strand.
